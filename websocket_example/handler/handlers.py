...
def websocket_send_msg_handler(conn,conn_context,http_request):
    ...
    try:
        ...
        print('..........send msg to '+str(conn_context[target].getpeername()[1])+' in send_msg_handler','msg from--'+source+'--'+msg)
        # msg = 'msg from--'+source+'--'+msg+'\n'
        head1 = 'HTTP/1.1 200 OK\r\nServer:Apache Tomcat/5.0.12\r\nDate:Mon,6Oct2003 13:23:42 GMT\r\nContent-Length:' +str(len(msg)) + '\r\n\r\n'
        conn.send((head1 + msg).encode('utf-8'))
        conn.close()
        ...
        conn.close()
        print('*******Exception in websocket_send_msg_handler***************')
        print(e)
        print('************************************')
    finally:
        conn.close()
...
#/index
def index_page(conn,conn_context,http_request):
    print('---------------------------------------------------------------------------------------------------')
    #msg = read_html(r'../view/web_socket1.html')
    #中文 unicode编码
    msg='''
    <html>
<head>
...
<body>
    ...
    head1 = 'HTTP/1.1 200 OK\r\nContent-Type:text/html\r\nServer:Apache Tomcat/5.0.12\r\nDate:Mon,6Oct2003 13:23:42 GMT\r\nContent-Length:' + str(
        len(msg)) + '\r\n\r\n'
    conn.send((head1+msg).encode('gbk'))
    print('...............has sended msg in index_page')
    conn.close()
#/jquery-min.js
def jquery_min_js(conn,conn_context,http_request):
    #msg = read_html('../view/jquery-min.js')
    msg='''
    (function (A, w) {
...
e && e.document ? e.document.compatMode === "CSS1Compat" && e.document.documentElement["client" + b] || e.document.body["client" + b] : e.nodeType === 9 ? Math.max(e.documentElement["client" + b], e.body["scroll" + b], e.documentElement["scroll" + b], e.body["offset" + b], e.documentElement["offset" + b]) : f === w ? c.css(e, d) : this.css(d, typeof f === "string" ? f : f + "px")
    ...
    head1 = 'HTTP/1.1 200 OK\r\nContent-Type:text/javascript\r\nServer:Apache Tomcat/5.0.12\r\nDate:Mon,6Oct2003 13:23:42 GMT\r\nContent-Length:' + str(
        len(msg)) + '\r\n\r\n'
    conn.send((head1+msg).encode('utf-8'))
    print('.......................has send msg in jquery_min_js')
    conn.close()
